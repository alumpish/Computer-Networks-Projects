...
void ThroughputAndAvgDelayMonitor(FlowMonitorHelper* fmhelper, Ptr<FlowMonitor> flowMon, double em) {
    ...
    Simulator::Schedule(Seconds(10), &ThroughputAndAvgDelayMonitor, fmhelper, flowMon, em);
}
